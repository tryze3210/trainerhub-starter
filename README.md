# TrainerHub — current version v159.2
...
This README describes the current roadmap state after v159.2 Remove Nested Scrollbars and Polish Profile Workbench. The v70-v95 platform-readiness block, v97-v105 content-learning launch block, v106-v120 production-launch block and v131-v150 UX redesign block are closed; the v151-v159.2 premium storefront, customer workspace and trainer workspace block is now implemented.
