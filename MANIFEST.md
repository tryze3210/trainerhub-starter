# MANIFEST — TrainerHub v165

This manifest describes the current repository state after v165 Premium Trainer Dashboard, Video Studio and Route QA Pass.

## Current Version

- Current roadmap version: `v165`
...
- Current storefront block: `v151-v165` premium brand foundation, marketing homepage, marketplace catalog, product detail landing pages, checkout shell, customer cabinet, product builder, video studio repair, profile workbench scroll polish, media picker single source of truth, trainer operations, trainer finance analytics, education/reviews/payout workbenches, trainer business/onboarding/status workbenches and trainer dashboard/video route QA
...
- `frontend/tests/contracts/design-system-contract.test.js` — v131-v165 design-system contract test.
...
Premium trainer cabinet modules:

- `frontend/src/modules/trainer-cabinet/components/trainer-cabinet-shell.tsx` — v157 trainer workspace shell.
- `frontend/src/modules/trainer-cabinet/components/trainer-cabinet-nav.tsx` — v157 trainer navigation.
- `frontend/src/modules/trainer-cabinet/components/trainer-format.ts` — v157 Russian trainer labels and formatting helpers.
- `frontend/src/modules/trainer-dashboard/components/trainer-dashboard-shell.tsx` — v157 compatibility wrapper.
- `frontend/src/app/trainer/dashboard/page.tsx` — v157 premium trainer overview.
- `frontend/src/app/trainer/business/page.tsx` — v157 business cockpit.
- `frontend/src/app/trainer/videos/page.tsx` — v157 video and materials workspace.
- `frontend/src/app/trainer/reviews/page.tsx` — v157 reviews workspace.
- `frontend/src/app/trainer/onboarding/page.tsx` — v157 trainer profile entry.
...
- `frontend/src/design-system/profile-workbench.tsx` — v159 shared premium profile workbench layer.
- `frontend/src/modules/customer-cabinet/components/customer-cabinet-shell.tsx` — v159 horizontal customer profile shell.
- `frontend/src/modules/trainer-cabinet/components/trainer-cabinet-shell.tsx` — v159 horizontal trainer profile shell.
- `frontend/src/modules/trainer-products/components/trainer-product-builder-dashboard.tsx` — v158 premium product builder.
- `frontend/src/modules/trainer-products/components/trainer-product-media-picker.tsx` — v160 product video library picker.
- `frontend/src/modules/trainer-products/components/trainer-selected-media-list.tsx` — v160 selected product media list.
- `frontend/src/modules/trainer-products/components/trainer-product-advanced-id-field.tsx` — v160 advanced manual media ID field.
- `frontend/src/modules/trainer-products/types/product-media.ts` — v160.4 shared product media video helpers.
- `frontend/src/app/profile-workbench.css` — v160.4 extracted profile/workbench/media picker CSS layer.
- `frontend/src/app/trainer-operations.css` — v161 premium trainer CRM and schedule operations CSS layer.
- `frontend/src/app/trainer-finance-analytics.css` — v162 premium trainer finance, sales and analytics CSS layer.
- `frontend/src/modules/trainer-operations/format.ts` — v161 Russian trainer operations status helpers.
- `frontend/src/modules/upload/components/trainer-upload-panel.tsx` — v158.2 thin trainer upload wrapper.
- `frontend/src/modules/upload/components/trainer-content-studio.tsx` — v158.2 upload-first video/material studio.
- `frontend/src/modules/upload/components/trainer-video-upload-card.tsx` — v158.2 premium video upload card.
- `frontend/src/modules/upload/components/trainer-content-card.tsx` — v158.2 trainer content card.
- `frontend/src/modules/upload/components/trainer-upload-format.ts` — v158.2 upload studio formatting helpers.
...
- `docs/design-system/v158_1_product_builder_video_studio_repair.md` — v158.1 product builder and video studio repair notes.
...
- `docs/design-system/v160_2_product_video_flow_stabilization.md` — v160.2 product/video flow stabilization notes.
- `docs/design-system/v160_3_product_media_picker_cleanup.md` — v160.3 media picker cleanup notes.
...
- `docs/design-system/v165_premium_trainer_dashboard_video_route_qa.md` — v165 premium trainer dashboard, video studio and route QA notes.
...
| v165 | Premium trainer dashboard, video studio and route QA pass | Current |
