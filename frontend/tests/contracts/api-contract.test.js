...
(function main() {
  ...
  assert.equal(route('/audit/admin/retention/preview/'), `${API_BASE_URL}/audit/admin/retention/preview/`);
  assert.equal(route('/audit/admin/retention/cleanup/'), `${API_BASE_URL}/audit/admin/retention/cleanup/`);
  assert.equal(route('/payouts/admin-ops/summary/'), `${API_BASE_URL}/payouts/admin-ops/summary/`);
  assert.equal(route('/payouts/admin-ops/requests/export.csv'), `${API_BASE_URL}/payouts/admin-ops/requests/export.csv`);
