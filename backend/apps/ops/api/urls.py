...
from apps.ops.api.views import (
    ...
    AdminOpsRunbookDetailView,
    AdminOpsRunbookIndexView,
    AdminProductionLaunchPackView,
...
urlpatterns = [
    ...
    path('admin/observability-runtime/', AdminObservabilityRuntimeView.as_view(), name='ops-admin-observability-runtime'),
    path('admin/production-readiness/', AdminProductionReadinessView.as_view(), name='ops-admin-production-readiness'),
    path('admin/launch-candidate/', AdminLaunchCandidateView.as_view(), name='ops-admin-launch-candidate'),
    path('admin/production-launch-pack/', AdminProductionLaunchPackView.as_view(), name='ops-admin-production-launch-pack'),
    path('admin/runbooks/', AdminOpsRunbookIndexView.as_view(), name='ops-admin-runbooks'),
    path('admin/runbooks/<str:key>/', AdminOpsRunbookDetailView.as_view(), name='ops-admin-runbook-detail'),
    path('admin/commerce-readiness/', AdminCommerceReadinessView.as_view(), name='ops-admin-commerce-readiness'),
    path('admin/global-search/', AdminGlobalSearchView.as_view(), name='ops-admin-global-search'),
    path('admin/support-console/', SupportConsoleView.as_view(), name='ops-admin-support-console'),
    path('admin/support-console/notifications/resend/', SupportNotificationResendView.as_view(), name='ops-admin-support-notification-resend'),
    path('admin/support-console/entitlements/fix/', SupportEntitlementFixView.as_view(), name='ops-admin-support-entitlement-fix'),
