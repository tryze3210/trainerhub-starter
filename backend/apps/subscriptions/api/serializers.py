...
class SubscriptionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Subscription
        fields = [
            'id', 'status', 'starts_at', 'ends_at', 'cancelled_at', 'auto_renew',
            'plan', 'plan_name', 'currency', 'amount', 'price_amount', 'started_at',
            'created_at', 'updated_at', 'current_period_start', 'current_period_end',
            'cancel_at', 'canceled_at', 'is_active', 'remaining_days', 'entitlement_count',
        ]
