...
class PaymentWebhookEvent(UUIDModel):
    ...
    class Meta:
        indexes = [
            models.Index(fields=['provider', 'status'], name='payments_webhook_provider_status_idx'),
            models.Index(fields=['event_type', 'received_at'], name='payments_webhook_type_received_idx'),
            models.Index(fields=['payment', 'status'], name='payments_webhook_payment_status_idx'),
        ]
